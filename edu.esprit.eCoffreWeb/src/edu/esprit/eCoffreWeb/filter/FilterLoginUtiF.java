...
@WebFilter(urlPatterns = "/pages/adminf/*", dispatcherTypes = {DispatcherType.REQUEST, DispatcherType.FORWARD})
public class FilterLoginUtiF implements Filter,Serializable {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		if ( (login != null) && (login.getUser() instanceof UTI_F) )
